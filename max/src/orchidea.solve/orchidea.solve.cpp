...
void orchmax_solve_free(t_session *x);
void orchmax_solve_assist(t_session *x, void *b, long m, long a, char *s);

void orchmax_solve_anything(t_session *x, t_symbol *s, long ac, t_atom *av);
void orchmax_solve_bang(t_session *x);
...
//
//t_max_err orchmax_solve_notify(t_session *x, t_symbol *s, t_symbol *msg, void *sender, void *data) {
//    t_symbol *attrname;
...
void ext_main(void *r) {
    ...
    c = class_new("orchidea.solve", (method)orchmax_solve_new, (method)orchmax_solve_free, (long)sizeof(t_session),
                  0L /* leave NULL!! */, A_GIMME, 0);

    class_addmethod(c, (method)orchmax_solve_anything,        "db_files",    A_GIMME, 0);
    class_addmethod(c, (method)orchmax_solve_anything,        "target",    A_GIMME, 0);
    class_addmethod(c, (method)orchmax_solve_anything,        "sound_paths",    A_GIMME, 0);
    class_addmethod(c, (method)orchmax_solve_anything,        "search",    A_GIMME, 0);
    class_addmethod(c, (method)orchmax_solve_anything,        "pop_size", A_GIMME, 0);
    class_addmethod(c, (method)orchmax_solve_anything,        "max_epochs", A_GIMME, 0);
    class_addmethod(c, (method)orchmax_solve_anything,        "pursuit", A_GIMME, 0);
    class_addmethod(c, (method)orchmax_solve_anything,        "xover_rate", A_GIMME, 0);
    class_addmethod(c, (method)orchmax_solve_anything,        "mutatioin_rate", A_GIMME, 0);
    class_addmethod(c, (method)orchmax_solve_anything,        "sparsity", A_GIMME, 0);
    class_addmethod(c, (method)orchmax_solve_anything,        "onsets_threshold", A_GIMME, 0);
    class_addmethod(c, (method)orchmax_solve_anything,        "onsets_timegate", A_GIMME, 0);
    class_addmethod(c, (method)orchmax_solve_anything,        "positive_penalization", A_GIMME, 0);
    class_addmethod(c, (method)orchmax_solve_anything,        "negative_penalization", A_GIMME, 0);
    class_addmethod(c, (method)orchmax_solve_anything,        "partials_window", A_GIMME, 0);
    class_addmethod(c, (method)orchmax_solve_anything,        "partials_filter", A_GIMME, 0);
    class_addmethod(c, (method)orchmax_solve_anything,        "orchestra",    A_GIMME, 0);
    class_addmethod(c, (method)orchmax_solve_anything,        "styles",    A_GIMME, 0);
    class_addmethod(c, (method)orchmax_solve_anything,        "dynamics",    A_GIMME, 0);
    class_addmethod(c, (method)orchmax_solve_anything,        "others",    A_GIMME, 0);
    class_addmethod(c, (method)orchmax_solve_anything,        "extra_pitches",    A_GIMME, 0);
    class_addmethod(c, (method)orchmax_solve_anything,        "reset",    A_GIMME, 0);
    class_addmethod(c, (method)orchmax_solve_anything,        "orchestrate",    A_GIMME, 0);
...
void *orchmax_solve_new(t_symbol *s, long argc, t_atom *argv) {
    ...
    if ((x = (t_session *)object_alloc((t_class*)orchmax_solve_class))) {
//        x->name = gensym("");
//        if (argc && argv) {
